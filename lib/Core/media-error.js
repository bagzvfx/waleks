...
export const proto = $root.proto = (() => {
    ...
    proto.MediaRetryNotification = (function() {
        ...
        MediaRetryNotification.encode = function encode(m, w, q) {
            if (!w)
                w = $Writer.create();
            if (q === undefined)
                q = 0;
        ...
        MediaRetryNotification.fromObject = function fromObject(d, n) {
            if (d instanceof $root.proto.MediaRetryNotification)
                return d;
            if (!$util.isObject(d))
                throw TypeError(".proto.MediaRetryNotification: object expected");
            if (n === undefined)
                n = 0;
        ...
        MediaRetryNotification.toObject = function toObject(m, o, q) {
            if (!o)
                o = {};
            if (q === undefined)
                q = 0;
            ...
            if (m.result != null && Object.hasOwnProperty.call(m, "result")) {
                d.result = o.enums === String ? $root.proto.MediaRetryNotification.ResultType[m.result] === undefined ? m.result : $root.proto.MediaRetryNotification.ResultType[m.result] : m.result;
                if (o.oneofs)
                    d._result = "result";
            }
            if (m.messageSecret != null && Object.hasOwnProperty.call(m, "messageSecret")) {
    ...
    proto.ServerErrorReceipt = (function() {
        ...
        ServerErrorReceipt.encode = function encode(m, w, q) {
            if (!w)
                w = $Writer.create();
            if (q === undefined)
                q = 0;
        ...
        ServerErrorReceipt.fromObject = function fromObject(d, n) {
            if (d instanceof $root.proto.ServerErrorReceipt)
                return d;
            if (!$util.isObject(d))
                throw TypeError(".proto.ServerErrorReceipt: object expected");
            if (n === undefined)
                n = 0;
            if (n > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
        ...
        ServerErrorReceipt.toObject = function toObject(m, o, q) {
            if (!o)
                o = {};
            if (q === undefined)
                q = 0;

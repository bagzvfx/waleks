...
export const proto = $root.proto = (() => {
    ...
    proto.Message = (function() {
        ...
        Message.PollContentType = (function() {
            ...
            PollContentType.create = function create(properties) {
                return new PollContentType(properties);
            };

            PollContentType.encode = function encode(m, w, q) {
                if (!w)
                    w = $Writer.create();
                if (q === undefined)
                    q = 0;
            ...
            PollContentType.decode = function decode(r, l, e, n) {
                ...
                var c = l === undefined ? r.len : r.pos + l, m = new $root.proto.Message.PollContentType();
                while (r.pos < c) {
                    var t = r.uint32();
                    if (t === e)
                        break;
            ...
            PollContentType.fromObject = function fromObject(d, n) {
                if (d instanceof $root.proto.Message.PollContentType)
                    return d;
                return new $root.proto.Message.PollContentType();
            };

            PollContentType.toObject = function toObject() {
                return {};
            };

            PollContentType.prototype.toJSON = function toJSON() {
                return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
            };

            PollContentType.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/proto.Message.PollContentType";
            };
        ...
        Message.PollCreationMessage = (function() {
            ...
            PollCreationMessage.encode = function encode(m, w, q) {
                ...
                if (m.options != null && m.options.length) {
                    for (var i = 0; i < m.options.length; ++i)
                        $root.proto.Message.PollCreationMessage.Option.encode(m.options[i], w.uint32(26).fork(), q + 1).ldelim();
                }
                ...
                if (m.contextInfo != null && Object.hasOwnProperty.call(m, "contextInfo"))
                    $root.proto.ContextInfo.encode(m.contextInfo, w.uint32(42).fork(), q + 1).ldelim();
                if (m.pollContentType != null && Object.hasOwnProperty.call(m, "pollContentType"))
                    $root.proto.Message.PollContentType.encode(m.pollContentType, w.uint32(50).fork(), q + 1).ldelim();
                if (m.pollType != null && Object.hasOwnProperty.call(m, "pollType"))
                    $root.proto.Message.PollType.encode(m.pollType, w.uint32(58).fork(), q + 1).ldelim();
                ...
                while (r.pos < c) {
                    ...
                    case 3: {
                            if (!(m.options && m.options.length))
                                m.options = [];
                            m.options.push($root.proto.Message.PollCreationMessage.Option.decode(r, r.uint32(), undefined, n + 1));
                            break;
                        }
                    case 4: {
                    ...
                    case 6: {
                            m.pollContentType = $root.proto.Message.PollContentType.decode(r, r.uint32(), undefined, n + 1);
                            break;
                        }
                    case 7: {
                            m.pollType = $root.proto.Message.PollType.decode(r, r.uint32(), undefined, n + 1);
                            break;
                        }
                    case 8: {
                            m.correctAnswer = $root.proto.Message.PollCreationMessage.Option.decode(r, r.uint32(), undefined, n + 1);
                            break;
                        }
                    default:
                        r.skipType(t & 7, n);
            ...
            PollCreationMessage.fromObject = function fromObject(d, n) {
                ...
                if (d.encKey != null) {
                    if (typeof d.encKey === "string")
                        $util.base64.decode(d.encKey, m.encKey = $util.newBuffer($util.base64.length(d.encKey)), 0);
                    else if (d.encKey.length >= 0)
                        m.encKey = d.encKey;
                }
                if (d.name != null) {
                ...
                if (d.options) {
                    ...
                    for (var i = 0; i < d.options.length; ++i) {
                        if (!$util.isObject(d.options[i]))
                            throw TypeError(".proto.Message.PollCreationMessage.options: object expected");
                        m.options[i] = $root.proto.Message.PollCreationMessage.Option.fromObject(d.options[i], n + 1);
                    }
                }
                if (d.selectableOptionsCount != null) {
                    m.selectableOptionsCount = d.selectableOptionsCount >>> 0;
                }
                ...
                if (d.pollContentType != null) {
                    if (!$util.isObject(d.pollContentType))
                        throw TypeError(".proto.Message.PollCreationMessage.pollContentType: object expected");
                    m.pollContentType = $root.proto.Message.PollContentType.fromObject(d.pollContentType, n + 1);
                }
                if (d.pollType != null) {
                    if (!$util.isObject(d.pollType))
                        throw TypeError(".proto.Message.PollCreationMessage.pollType: object expected");
                    m.pollType = $root.proto.Message.PollType.fromObject(d.pollType, n + 1);
                }
                if (d.correctAnswer != null) {
                    if (!$util.isObject(d.correctAnswer))
                        throw TypeError(".proto.Message.PollCreationMessage.correctAnswer: object expected");
                    m.correctAnswer = $root.proto.Message.PollCreationMessage.Option.fromObject(d.correctAnswer, n + 1);
                }
                return m;
            };

            PollCreationMessage.toObject = function toObject(m, o, q) {
                if (!o)
                    o = {};
                if (q === undefined)
                    q = 0;
                ...
                if (m.encKey != null && Object.hasOwnProperty.call(m, "encKey")) {
                    d.encKey = o.bytes === String ? $util.base64.encode(m.encKey, 0, m.encKey.length) : o.bytes === Array ? Array.prototype.slice.call(m.encKey) : m.encKey;
                    if (o.oneofs)
                        d._encKey = "encKey";
                }
                if (m.name != null && Object.hasOwnProperty.call(m, "name")) {
                ...
                if (m.options && m.options.length) {
                    ...
                    for (var j = 0; j < m.options.length; ++j) {
                        d.options[j] = $root.proto.Message.PollCreationMessage.Option.toObject(m.options[j], o, q + 1);
                    }
                }
                if (m.selectableOptionsCount != null && Object.hasOwnProperty.call(m, "selectableOptionsCount")) {
                    d.selectableOptionsCount = m.selectableOptionsCount;
                    if (o.oneofs)
                        d._selectableOptionsCount = "selectableOptionsCount";
                }
                if (m.contextInfo != null && Object.hasOwnProperty.call(m, "contextInfo")) {
                ...
                if (m.pollContentType != null && Object.hasOwnProperty.call(m, "pollContentType")) {
                    d.pollContentType = $root.proto.Message.PollContentType.toObject(m.pollContentType, o, q + 1);
                    if (o.oneofs)
                        d._pollContentType = "pollContentType";
                }
                if (m.pollType != null && Object.hasOwnProperty.call(m, "pollType")) {
                    d.pollType = $root.proto.Message.PollType.toObject(m.pollType, o, q + 1);
                    if (o.oneofs)
            ...
            PollCreationMessage.Option = (function() {
                ...
                Option.encode = function encode(m, w, q) {
                    if (!w)
                        w = $Writer.create();
                    if (q === undefined)
                        q = 0;
                ...
                Option.decode = function decode(r, l, e, n) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                    if (n === undefined)
                        n = 0;
                ...
                Option.fromObject = function fromObject(d, n) {
                    if (d instanceof $root.proto.Message.PollCreationMessage.Option)
                        return d;
                    if (!$util.isObject(d))
                        throw TypeError(".proto.Message.PollCreationMessage.Option: object expected");
                    if (n === undefined)
                        n = 0;
                    if (n > $util.recursionLimit)
                        throw Error("maximum nesting depth exceeded");
                    var m = new $root.proto.Message.PollCreationMessage.Option();
                    if (d.optionName != null) {
                        m.optionName = String(d.optionName);
                    }
                    if (d.optionHash != null) {
                        m.optionHash = String(d.optionHash);
                    }
                    return m;
                };

                Option.toObject = function toObject(m, o, q) {
                    if (!o)
                        o = {};
                    if (q === undefined)
                        q = 0;
                    ...
                    var d = {};
                    if (m.optionName != null && Object.hasOwnProperty.call(m, "optionName")) {
                        d.optionName = m.optionName;
                        if (o.oneofs)
                            d._optionName = "optionName";
                    }
                    if (m.optionHash != null && Object.hasOwnProperty.call(m, "optionHash")) {
                        d.optionHash = m.optionHash;
                        if (o.oneofs)
                            d._optionHash = "optionHash";
                    }
                    return d;
                };
        ...
        Message.PollEncValue = (function() {
            ...
            PollEncValue.encode = function encode(m, w, q) {
                if (!w)
                    w = $Writer.create();
                if (q === undefined)
                    q = 0;
            ...
            PollEncValue.fromObject = function fromObject(d, n) {
                if (d instanceof $root.proto.Message.PollEncValue)
                    return d;
                return new $root.proto.Message.PollEncValue();
            };

            PollEncValue.toObject = function toObject() {
                return {};
            };
        ...
        Message.PollType = (function() {
            ...
            PollType.create = function create(properties) {
                return new PollType(properties);
            };

            PollType.encode = function encode(m, w, q) {
                if (!w)
                    w = $Writer.create();
                if (q === undefined)
                    q = 0;
            ...
            PollType.decode = function decode(r, l, e, n) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                if (n === undefined)
                    n = 0;
                if (n > $Reader.recursionLimit)
                    throw Error("maximum nesting depth exceeded");
                var c = l === undefined ? r.len : r.pos + l, m = new $root.proto.Message.PollType();
                while (r.pos < c) {
                    var t = r.uint32();
                    if (t === e)
                        break;
            ...
            PollType.fromObject = function fromObject(d, n) {
                if (d instanceof $root.proto.Message.PollType)
                    return d;
                return new $root.proto.Message.PollType();
            };

            PollType.toObject = function toObject() {
                return {};
            };

            PollType.prototype.toJSON = function toJSON() {
                return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
            };

            PollType.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/proto.Message.PollType";
            };
        ...
        Message.PollUpdateMessage = (function() {
            ...
            PollUpdateMessage.encode = function encode(m, w, q) {
                ...
                if (m.pollCreationMessageKey != null && Object.hasOwnProperty.call(m, "pollCreationMessageKey"))
                    $root.proto.MessageKey.encode(m.pollCreationMessageKey, w.uint32(10).fork(), q + 1).ldelim();
                if (m.vote != null && Object.hasOwnProperty.call(m, "vote"))
                    $root.proto.Message.PollEncValue.encode(m.vote, w.uint32(18).fork(), q + 1).ldelim();
                if (m.metadata != null && Object.hasOwnProperty.call(m, "metadata"))
                    $root.proto.Message.PollUpdateMessageMetadata.encode(m.metadata, w.uint32(26).fork(), q + 1).ldelim();
            ...
            PollUpdateMessage.decode = function decode(r, l, e, n) {
                ...
                while (r.pos < c) {
                    ...
                    switch (t >>> 3) {
                    case 1: {
                            m.pollCreationMessageKey = $root.proto.MessageKey.decode(r, r.uint32(), undefined, n + 1);
                            break;
                        }
                    case 2: {
                            m.vote = $root.proto.Message.PollEncValue.decode(r, r.uint32(), undefined, n + 1);
                            break;
                        }
                    case 3: {
            ...
            PollUpdateMessage.fromObject = function fromObject(d, n) {
                ...
                if (d.pollCreationMessageKey != null) {
                    if (!$util.isObject(d.pollCreationMessageKey))
                        throw TypeError(".proto.Message.PollUpdateMessage.pollCreationMessageKey: object expected");
                    m.pollCreationMessageKey = $root.proto.MessageKey.fromObject(d.pollCreationMessageKey, n + 1);
                }
                if (d.vote != null) {
                    if (!$util.isObject(d.vote))
                        throw TypeError(".proto.Message.PollUpdateMessage.vote: object expected");
                    m.vote = $root.proto.Message.PollEncValue.fromObject(d.vote, n + 1);
                }
                if (d.metadata != null) {
            ...
            PollUpdateMessage.toObject = function toObject(m, o, q) {
                if (!o)
                    o = {};
                if (q === undefined)
                    q = 0;
                ...
                var d = {};
                if (m.pollCreationMessageKey != null && Object.hasOwnProperty.call(m, "pollCreationMessageKey")) {
                    d.pollCreationMessageKey = $root.proto.MessageKey.toObject(m.pollCreationMessageKey, o, q + 1);
                    if (o.oneofs)
                        d._pollCreationMessageKey = "pollCreationMessageKey";
                }
                if (m.vote != null && Object.hasOwnProperty.call(m, "vote")) {
                    d.vote = $root.proto.Message.PollEncValue.toObject(m.vote, o, q + 1);
                    if (o.oneofs)
                        d._vote = "vote";
                }
                if (m.metadata != null && Object.hasOwnProperty.call(m, "metadata")) {
                    d.metadata = $root.proto.Message.PollUpdateMessageMetadata.toObject(m.metadata, o, q + 1);
                    if (o.oneofs)
        ...
        Message.PollUpdateMessageMetadata = (function() {
            ...
            PollUpdateMessageMetadata.encode = function encode(m, w, q) {
                if (!w)
                    w = $Writer.create();
                if (q === undefined)
                    q = 0;
            ...
            PollUpdateMessageMetadata.decode = function decode(r, l, e, n) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                if (n === undefined)
                    n = 0;
            ...
            PollUpdateMessageMetadata.fromObject = function fromObject(d, n) {
    ...
    proto.MessageKey = proto.MessageKey || createEmptyMessage("MessageKey")

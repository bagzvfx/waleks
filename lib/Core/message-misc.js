...
export const proto = $root.proto = (() => {
    ...
    proto.AIQueryFanout = proto.AIQueryFanout || createEmptyMessage("AIQueryFanout")
    ...
    proto.BotFeedbackMessage = proto.BotFeedbackMessage || createEmptyMessage("BotFeedbackMessage")
    ...
    proto.EmbeddedMusic = proto.EmbeddedMusic || createEmptyMessage("EmbeddedMusic")
    ...
    proto.HydratedTemplateButton = proto.HydratedTemplateButton || createEmptyMessage("HydratedTemplateButton")
    ...
    proto.LIDMigrationMappingSyncMessage = proto.LIDMigrationMappingSyncMessage || createEmptyMessage("LIDMigrationMappingSyncMessage")

    proto.LimitSharing = proto.LimitSharing || createEmptyMessage("LimitSharing")

    proto.MediaNotifyMessage = proto.MediaNotifyMessage || createEmptyMessage("MediaNotifyMessage")
    ...
    proto.Message = proto.Message || createEmptyMessage("Message")
    ...
    proto.Money = proto.Money || createEmptyMessage("Money")
    ...
    proto.PaymentBackground = proto.PaymentBackground || createEmptyMessage("PaymentBackground")
    ...
    proto.TemplateButton = proto.TemplateButton || createEmptyMessage("TemplateButton")

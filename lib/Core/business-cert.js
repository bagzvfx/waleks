...
export const proto = $root.proto = (() => {
    ...
    proto.VerifiedNameCertificate = (function() {
        ...
        VerifiedNameCertificate.encode = function encode(m, w, q) {
            if (!w)
                w = $Writer.create();
            if (q === undefined)
                q = 0;
        ...
        VerifiedNameCertificate.fromObject = function fromObject(d, n) {
            if (d instanceof $root.proto.VerifiedNameCertificate)
                return d;
            if (!$util.isObject(d))
                throw TypeError(".proto.VerifiedNameCertificate: object expected");
            if (n === undefined)
                n = 0;
        ...
        VerifiedNameCertificate.toObject = function toObject(m, o, q) {
            if (!o)
                o = {};
            if (q === undefined)
                q = 0;

...
export const proto = $root.proto = (() => {
    ...
    proto.ExitCode = proto.ExitCode || createEmptyMessage("ExitCode")
    ...
    proto.ExternalBlobReference = (function() {
        ...
        ExternalBlobReference.encode = function encode(m, w, q) {
            if (!w)
                w = $Writer.create();
            if (q === undefined)
                q = 0;
        ...
        ExternalBlobReference.fromObject = function fromObject(d, n) {
            if (d instanceof $root.proto.ExternalBlobReference)
                return d;
            if (!$util.isObject(d))
                throw TypeError(".proto.ExternalBlobReference: object expected");
            if (n === undefined)
                n = 0;
        ...
        ExternalBlobReference.toObject = function toObject(m, o, q) {
            if (!o)
                o = {};
            if (q === undefined)
                q = 0;
    ...
    proto.KeyId = proto.KeyId || createEmptyMessage("KeyId")
    ...
    proto.SyncActionData = (function() {
        ...
        SyncActionData.encode = function encode(m, w, q) {
            if (!w)
                w = $Writer.create();
            if (q === undefined)
                q = 0;
            ...
            if (m.value != null && Object.hasOwnProperty.call(m, "value"))
                $root.proto.SyncActionValue.encode(m.value, w.uint32(18).fork(), q + 1).ldelim();
        ...
        SyncActionData.decode = function decode(r, l, e, n) {
            ...
            while (r.pos < c) {
                ...
                case 2: {
                        m.value = $root.proto.SyncActionValue.decode(r, r.uint32(), undefined, n + 1);
                        break;
                    }
                case 3: {
                        m.padding = r.bytes();
        ...
        SyncActionData.fromObject = function fromObject(d, n) {
            if (d instanceof $root.proto.SyncActionData)
                return d;
            if (!$util.isObject(d))
                throw TypeError(".proto.SyncActionData: object expected");
            if (n === undefined)
                n = 0;
            if (n > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            ...
            if (d.value != null) {
                ...
                m.value = $root.proto.SyncActionValue.fromObject(d.value, n + 1);
            }
            if (d.padding != null) {
        ...
        SyncActionData.toObject = function toObject(m, o, q) {
            if (!o)
                o = {};
            if (q === undefined)
                q = 0;
            ...
            if (m.value != null && Object.hasOwnProperty.call(m, "value")) {
                d.value = $root.proto.SyncActionValue.toObject(m.value, o, q + 1);
                if (o.oneofs)
                    d._value = "value";
            }
            if (m.padding != null && Object.hasOwnProperty.call(m, "padding")) {
    ...
    proto.SyncActionValue = proto.SyncActionValue || createEmptyMessage("SyncActionValue")
    ...
    proto.SyncdMutation = (function() {
        ...
        SyncdMutation.encode = function encode(m, w, q) {
            if (!w)
                w = $Writer.create();
            if (q === undefined)
                q = 0;
            ...
            if (m.record != null && Object.hasOwnProperty.call(m, "record"))
                $root.proto.SyncdRecord.encode(m.record, w.uint32(18).fork(), q + 1).ldelim();
            return w;
        };
        ...
        SyncdMutation.decode = function decode(r, l, e, n) {
            ...
            while (r.pos < c) {
                ...
                case 2: {
                        m.record = $root.proto.SyncdRecord.decode(r, r.uint32(), undefined, n + 1);
                        break;
                    }
                default:
                    r.skipType(t & 7, n);
        ...
        SyncdMutation.fromObject = function fromObject(d, n) {
            if (d instanceof $root.proto.SyncdMutation)
                return d;
            if (!$util.isObject(d))
                throw TypeError(".proto.SyncdMutation: object expected");
            if (n === undefined)
                n = 0;
            if (n > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            ...
            if (d.record != null) {
                ...
                m.record = $root.proto.SyncdRecord.fromObject(d.record, n + 1);
            }
            return m;
        };

        SyncdMutation.toObject = function toObject(m, o, q) {
            if (!o)
                o = {};
            if (q === undefined)
                q = 0;
            ...
            if (m.record != null && Object.hasOwnProperty.call(m, "record")) {
                d.record = $root.proto.SyncdRecord.toObject(m.record, o, q + 1);
                if (o.oneofs)
                    d._record = "record";
            }
            return d;
    ...
    proto.SyncdMutations = (function() {
        ...
        SyncdMutations.encode = function encode(m, w, q) {
            if (!w)
                w = $Writer.create();
            if (q === undefined)
                q = 0;
            ...
            if (m.mutations != null && m.mutations.length) {
                for (var i = 0; i < m.mutations.length; ++i)
                    $root.proto.SyncdMutation.encode(m.mutations[i], w.uint32(10).fork(), q + 1).ldelim();
            }
            return w;
        };
            ...
            while (r.pos < c) {
                ...
                case 1: {
                        if (!(m.mutations && m.mutations.length))
                            m.mutations = [];
                        m.mutations.push($root.proto.SyncdMutation.decode(r, r.uint32(), undefined, n + 1));
                        break;
                    }
                default:
                    r.skipType(t & 7, n);
        ...
        SyncdMutations.fromObject = function fromObject(d, n) {
            if (d instanceof $root.proto.SyncdMutations)
                return d;
            if (!$util.isObject(d))
                throw TypeError(".proto.SyncdMutations: object expected");
            if (n === undefined)
                n = 0;
            if (n > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            ...
            if (d.mutations) {
                ...
                for (var i = 0; i < d.mutations.length; ++i) {
                    ...
                    m.mutations[i] = $root.proto.SyncdMutation.fromObject(d.mutations[i], n + 1);
                }
            }
            return m;
        };

        SyncdMutations.toObject = function toObject(m, o, q) {
            if (!o)
                o = {};
            if (q === undefined)
                q = 0;
            ...
            if (m.mutations && m.mutations.length) {
                ...
                for (var j = 0; j < m.mutations.length; ++j) {
                    d.mutations[j] = $root.proto.SyncdMutation.toObject(m.mutations[j], o, q + 1);
                }
            }
            return d;
        };
    ...
    proto.SyncdPatch = (function() {
        ...
        SyncdPatch.encode = function encode(m, w, q) {
            if (!w)
                w = $Writer.create();
            if (q === undefined)
                q = 0;
            if (q > $util.recursionLimit)
                throw Error("max depth exceeded");
            if (m.version != null && Object.hasOwnProperty.call(m, "version"))
                $root.proto.SyncdVersion.encode(m.version, w.uint32(10).fork(), q + 1).ldelim();
            if (m.mutations != null && m.mutations.length) {
                for (var i = 0; i < m.mutations.length; ++i)
                    $root.proto.SyncdMutation.encode(m.mutations[i], w.uint32(18).fork(), q + 1).ldelim();
            }
            if (m.externalMutations != null && Object.hasOwnProperty.call(m, "externalMutations"))
                $root.proto.ExternalBlobReference.encode(m.externalMutations, w.uint32(26).fork(), q + 1).ldelim();
            ...
            if (m.keyId != null && Object.hasOwnProperty.call(m, "keyId"))
                $root.proto.KeyId.encode(m.keyId, w.uint32(50).fork(), q + 1).ldelim();
            if (m.exitCode != null && Object.hasOwnProperty.call(m, "exitCode"))
                $root.proto.ExitCode.encode(m.exitCode, w.uint32(58).fork(), q + 1).ldelim();
        ...
        SyncdPatch.decode = function decode(r, l, e, n) {
            ...
            while (r.pos < c) {
                ...
                switch (t >>> 3) {
                case 1: {
                        m.version = $root.proto.SyncdVersion.decode(r, r.uint32(), undefined, n + 1);
                        break;
                    }
                case 2: {
                        if (!(m.mutations && m.mutations.length))
                ...
                case 3: {
                        m.externalMutations = $root.proto.ExternalBlobReference.decode(r, r.uint32(), undefined, n + 1);
                        break;
                    }
                case 4: {
                ...
                case 6: {
                        m.keyId = $root.proto.KeyId.decode(r, r.uint32(), undefined, n + 1);
                        break;
                    }
                case 7: {
                        m.exitCode = $root.proto.ExitCode.decode(r, r.uint32(), undefined, n + 1);
                        break;
                    }
                case 8: {
        ...
        SyncdPatch.fromObject = function fromObject(d, n) {
            if (d instanceof $root.proto.SyncdPatch)
                return d;
            if (!$util.isObject(d))
                throw TypeError(".proto.SyncdPatch: object expected");
            if (n === undefined)
                n = 0;
            if (n > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            ...
            if (d.version != null) {
                ...
                m.version = $root.proto.SyncdVersion.fromObject(d.version, n + 1);
            }
            if (d.mutations) {
                if (!Array.isArray(d.mutations))
            ...
            if (d.externalMutations != null) {
                ...
                m.externalMutations = $root.proto.ExternalBlobReference.fromObject(d.externalMutations, n + 1);
            }
            ...
            if (d.keyId != null) {
                ...
                m.keyId = $root.proto.KeyId.fromObject(d.keyId, n + 1);
            }
            if (d.exitCode != null) {
                if (!$util.isObject(d.exitCode))
                    throw TypeError(".proto.SyncdPatch.exitCode: object expected");
                m.exitCode = $root.proto.ExitCode.fromObject(d.exitCode, n + 1);
            }
        ...
        SyncdPatch.toObject = function toObject(m, o, q) {
            if (!o)
                o = {};
            if (q === undefined)
                q = 0;
            ...
            if (m.version != null && Object.hasOwnProperty.call(m, "version")) {
                d.version = $root.proto.SyncdVersion.toObject(m.version, o, q + 1);
                if (o.oneofs)
                    d._version = "version";
            }
            if (m.mutations && m.mutations.length) {
            ...
            if (m.externalMutations != null && Object.hasOwnProperty.call(m, "externalMutations")) {
                d.externalMutations = $root.proto.ExternalBlobReference.toObject(m.externalMutations, o, q + 1);
                if (o.oneofs)
            ...
            if (m.keyId != null && Object.hasOwnProperty.call(m, "keyId")) {
                d.keyId = $root.proto.KeyId.toObject(m.keyId, o, q + 1);
                if (o.oneofs)
                    d._keyId = "keyId";
            }
            if (m.exitCode != null && Object.hasOwnProperty.call(m, "exitCode")) {
                d.exitCode = $root.proto.ExitCode.toObject(m.exitCode, o, q + 1);
                if (o.oneofs)
    ...
    proto.SyncdRecord = proto.SyncdRecord || createEmptyMessage("SyncdRecord")
    ...
    proto.SyncdSnapshot = (function() {
        ...
        SyncdSnapshot.encode = function encode(m, w, q) {
            if (!w)
                w = $Writer.create();
            if (q === undefined)
                q = 0;
            ...
            if (m.records != null && m.records.length) {
                for (var i = 0; i < m.records.length; ++i)
                    $root.proto.SyncdRecord.encode(m.records[i], w.uint32(18).fork(), q + 1).ldelim();
            }
            if (m.mac != null && Object.hasOwnProperty.call(m, "mac"))
                w.uint32(26).bytes(m.mac);
            if (m.keyId != null && Object.hasOwnProperty.call(m, "keyId"))
                $root.proto.KeyId.encode(m.keyId, w.uint32(34).fork(), q + 1).ldelim();
            return w;
        };
            ...
            while (r.pos < c) {
                ...
                case 2: {
                        if (!(m.records && m.records.length))
                            m.records = [];
                        m.records.push($root.proto.SyncdRecord.decode(r, r.uint32(), undefined, n + 1));
                        break;
                    }
                case 3: {
                        m.mac = r.bytes();
        ...
        SyncdSnapshot.fromObject = function fromObject(d, n) {
            if (d instanceof $root.proto.SyncdSnapshot)
                return d;
            if (!$util.isObject(d))
                throw TypeError(".proto.SyncdSnapshot: object expected");
            if (n === undefined)
                n = 0;
            if (n > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            ...
            if (d.records) {
                ...
                for (var i = 0; i < d.records.length; ++i) {
                    ...
                    m.records[i] = $root.proto.SyncdRecord.fromObject(d.records[i], n + 1);
                }
            }
            if (d.mac != null) {
        ...
        SyncdSnapshot.toObject = function toObject(m, o, q) {
            if (!o)
                o = {};
            if (q === undefined)
                q = 0;
            ...
            if (m.records && m.records.length) {
                ...
                for (var j = 0; j < m.records.length; ++j) {
                    d.records[j] = $root.proto.SyncdRecord.toObject(m.records[j], o, q + 1);
                }
            }
            if (m.mac != null && Object.hasOwnProperty.call(m, "mac")) {
    ...
    proto.SyncdVersion = proto.SyncdVersion || createEmptyMessage("SyncdVersion")
